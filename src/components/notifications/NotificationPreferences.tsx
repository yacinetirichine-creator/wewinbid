...
const entries = {
  'notificationPreferences.loadError': 'Erreur de chargement',
  'notificationPreferences.loadErrorMessage': 'Une erreur est survenue lors du chargement de vos préférences',
  'notificationPreferences.saveError': 'Erreur de sauvegarde',
  'notificationPreferences.saveErrorMessage': 'Une erreur est survenue lors de la sauvegarde',
  'notificationPreferences.saveSuccess': 'Préférences enregistrées avec succès',
  'notificationPreferences.title': 'Préférences de notifications',
  'notificationPreferences.channels.title': 'Canaux de notification',
  'notificationPreferences.channels.email.label': 'Notifications par email',
  'notificationPreferences.channels.email.description': 'Recevoir les notifications par email',
  'notificationPreferences.channels.push.label': 'Notifications push',
  'notificationPreferences.channels.push.description': 'Recevoir les notifications dans l\'application',
  'notificationPreferences.deadlines.title': 'Alertes de deadline',
  'notificationPreferences.deadlines.7d.label': '7 jours avant',
  'notificationPreferences.deadlines.7d.description': 'Alerte 7 jours avant la date limite',
  'notificationPreferences.deadlines.3d.label': '3 jours avant',
  'notificationPreferences.deadlines.3d.description': 'Alerte 3 jours avant la date limite',
  'notificationPreferences.deadlines.24h.label': '24 heures avant',
  'notificationPreferences.deadlines.24h.description': 'Alerte 24 heures avant la date limite',
  'notificationPreferences.activity.title': 'Activité',
  'notificationPreferences.activity.tenderStatus.label': 'Changement de statut d\'AO',
  'notificationPreferences.activity.tenderStatus.description': 'Être notifié quand un appel d\'offres change de statut',
  'notificationPreferences.activity.team.label': 'Activité d\'équipe',
  'notificationPreferences.activity.team.description': 'Notifications sur les invitations et l\'activité d\'équipe',
  'notificationPreferences.activity.marketing.label': 'Communications marketing',
  'notificationPreferences.activity.marketing.description': 'Nouvelles fonctionnalités, conseils et offres',
  'notificationPreferences.actions.saving': 'Enregistrement...',
  'notificationPreferences.actions.save': 'Enregistrer les préférences',
} as const;
