...
export default function RegisterPage() {
  ...
  const REGISTER_TRANSLATIONS: Record<string, Record<string, string>> = {
    ...
    en: {
      ...
      'auth.register.left.feature2.desc': 'Cancel anytime',
      'auth.register.left.feature3.title': 'Dedicated support',
      'auth.register.left.feature3.desc': 'Our team is here to help',

      'auth.register.steps.account': 'Account',
      'auth.register.steps.company': 'Company',
      'auth.register.steps.confirmation': 'Confirmation',
      ...
      'auth.register.step1.lastName.placeholder': 'Doe',
      'auth.register.step1.email.label': 'Work email *',
      'auth.register.step1.email.placeholder': 'you@company.com',
      'auth.register.step1.phone.label': 'Phone',
      'auth.register.step1.phone.placeholder': '+33 6 12 34 56 78',
      'auth.register.step1.password.label': 'Password *',
      'auth.register.step1.password.placeholder': 'At least 8 characters',
      'auth.register.step1.confirmPassword.label': 'Confirm password *',
      'auth.register.step1.confirmPassword.placeholder': '••••••••',
      ...
      'auth.register.step2.sector.label': 'Industry *',
      'auth.register.step2.sector.placeholder': 'Select an industry',
      'auth.register.step2.companySize.label': 'Company size',
      'auth.register.step2.companySize.placeholder': 'Select a size',
      'auth.register.step2.address.label': 'Address',
      'auth.register.step2.address.placeholder': '123 Main Street',
      'auth.register.step2.postalCode.label': 'Postal code',
      'auth.register.step2.postalCode.placeholder': '75001',
      'auth.register.step2.city.label': 'City',
      'auth.register.step2.city.placeholder': 'Paris',

      'auth.register.step3.title': 'Confirmation',
      'auth.register.step3.subtitle': 'Last step before getting started',
      'auth.register.step3.summary.email': 'Email',
      'auth.register.step3.summary.name': 'Name',
      'auth.register.step3.summary.company': 'Company',
      'auth.register.step3.summary.siret': 'SIRET',
      'auth.register.step3.summary.sector': 'Industry',
      'auth.register.step3.acceptTerms.prefix': 'I accept the',
      'auth.register.step3.acceptTerms.and': 'and the',
      'auth.register.step3.acceptTerms.terms': 'Terms of Service',
      'auth.register.step3.acceptTerms.privacy': 'Privacy Policy',
      'auth.register.step3.acceptTerms.requiredMarker': '*',
      'auth.register.step3.newsletter': 'I want to receive WeWinBid news and tips by email',

      'auth.register.actions.continue': 'Continue',
      'auth.register.actions.back': 'Back',
      'auth.register.actions.or': 'or',
      'auth.register.actions.continueWithGoogle': 'Continue with Google',
      'auth.register.actions.creating': 'Creating...',
      'auth.register.actions.createAccount': 'Create my account',
      'auth.register.footer.haveAccount': 'Already have an account?',
      'auth.register.footer.signIn': 'Sign in',

      'auth.register.errors.requiredFields': 'Please fill in all required fields',
      ...
      'auth.register.errors.invalidSiret': 'SIRET must be exactly 14 digits',
      'auth.register.errors.mustAcceptTerms': 'You must accept the terms',
      'auth.register.errors.emailAlreadyRegistered': 'An account already exists with this email address',
      'auth.register.errors.generic': 'An error occurred. Please try again.',
      'auth.register.errors.googleGeneric': 'An error occurred with Google. Please try again.',

      // Options
      'auth.register.sectors.security': 'Private security',
      'auth.register.sectors.electronic_security': 'Electronic security',
      'auth.register.sectors.construction': 'Construction',
      'auth.register.sectors.logistics': 'Logistics',
      'auth.register.sectors.software': 'Software development',
      'auth.register.sectors.maintenance': 'Maintenance',
      'auth.register.sectors.consulting': 'Consulting',
      'auth.register.sectors.other': 'Other',
      'auth.register.companySizes.1-10': '1-10 employees',
      'auth.register.companySizes.11-50': '11-50 employees',
        ...
        >
          <div className="lg:hidden mb-8 text-center">
            <Link href="/" className="inline-flex items-center gap-3 mb-6">
              ...
              <span className="text-2xl font-bold text-white">{t('common.brand')}</span>
            </Link>
          </div>
