...
export default function NewTenderPage() {
  ...
  const entries = useMemo(
    () => ({
      ...(locale === 'fr' ? {
        // Page
        'tenders.new.pageTitle': 'Nouvel appel d\'offres',
        'tenders.new.pageDescription': 'Créez un nouvel appel d\'offres en quelques étapes',

        // Steps
        'tenders.new.steps.typeInfo': 'Type & Infos',
        'tenders.new.steps.buyer': 'Acheteur',
        'tenders.new.steps.budgetDates': 'Budget & Dates',
        'tenders.new.steps.details': 'Détails',

        // Step 1 - Type
        'tenders.new.section.tenderType': 'Type d\'appel d\'offres',
        'tenders.new.type.public': 'Marché public',
        'tenders.new.type.public.desc': 'État, collectivités locales, établissements publics',
        'tenders.new.type.private': 'Marché privé',
        'tenders.new.type.private.desc': 'Entreprises privées, associations',
        'tenders.new.badge.requiredDocs': '{count} documents requis',
        'tenders.new.badge.simplifiedProcedure': 'Procédure simplifiée',

        // Country
        'tenders.new.label.country': 'Pays',
        'tenders.new.hint.regulation': 'Réglementation : {law}',

        // Title & Description
        'tenders.new.label.title': 'Titre de l\'appel d\'offres',
        'tenders.new.placeholder.title': 'Ex : Fourniture de matériel informatique...',
        'tenders.new.label.description': 'Description',
        'tenders.new.placeholder.description': 'Décrivez l\'objet du marché...',

        // Sector
        'tenders.new.label.sector': 'Secteur d\'activité',
        'tenders.new.placeholder.sector': 'Sélectionnez un secteur',

        // Step 2 - Buyer
        'tenders.new.section.buyerInfo': 'Informations sur l\'acheteur',
        'tenders.new.label.buyerName': 'Nom de l\'acheteur',
        'tenders.new.placeholder.buyerName': 'Ex : Ville de Paris, SNCF...',
        'tenders.new.label.buyerType': 'Type d\'acheteur',
        'tenders.new.placeholder.buyerType': 'Sélectionnez un type',
        'tenders.new.label.contact': 'Contact',
        'tenders.new.placeholder.contact': 'Nom du contact',
        'tenders.new.label.email': 'Email',
        'tenders.new.label.phone': 'Téléphone',

        // Step 3 - Budget & Dates
        'tenders.new.section.budgetDates': 'Budget et dates limites',
        'tenders.new.label.estimatedValue': 'Valeur estimée ({currency})',
        'tenders.new.placeholder.estimatedValue': 'Ex : 50000',
        'tenders.new.label.deadline': 'Date limite de réponse',
        'tenders.new.label.publicationDate': 'Date de publication',

        // Legal deadlines alert
        'tenders.new.alert.legalDeadlines': 'Délais légaux ({country}) :',
        'tenders.new.alert.openProcedure': 'Procédure ouverte : {days} jours min.',
        'tenders.new.alert.restrictedProcedure': 'Procédure restreinte : {days} jours min.',
        'tenders.new.alert.urgentProcedure': 'Procédure urgente : {days} jours min.',

        // Step 4 - Details
        'tenders.new.section.details': 'Détails supplémentaires',
        'tenders.new.label.sourceUrl': 'URL source',
        'tenders.new.label.platform': 'Plateforme de publication',
        'tenders.new.placeholder.platform': 'Sélectionnez une plateforme',
        'tenders.new.label.region': 'Région',
        'tenders.new.placeholder.region': 'Ex : Île-de-France',
        'tenders.new.label.department': 'Département',
        'tenders.new.placeholder.department': 'Ex : 75 - Paris',
        'tenders.new.label.notes': 'Notes internes',
        'tenders.new.placeholder.notes': 'Informations complémentaires...',

        // Documents
        'tenders.new.docsToPrepare': 'Documents à préparer ({type})',
        'tenders.new.typeLabel.public': 'Marché public',
        'tenders.new.typeLabel.private': 'Marché privé',
        'tenders.new.badge.required': 'Requis',
        'tenders.new.moreDocs': '+{count} autres documents',

        // Navigation
        'tenders.new.nav.previous': 'Précédent',
        'tenders.new.nav.next': 'Suivant',
        'tenders.new.nav.create': 'Créer l\'appel d\'offres',

        // Validation
        'tenders.new.validation.titleRequired': 'Le titre est obligatoire',
        'tenders.new.validation.titleMin': 'Le titre doit contenir au moins 10 caractères',
        'tenders.new.validation.buyerRequired': 'Le nom de l\'acheteur est obligatoire',
        'tenders.new.validation.deadlineRequired': 'La date limite est obligatoire',

        // Errors & Toasts
        'tenders.new.error.unauthenticated': 'Non authentifié',
        'tenders.new.error.noCompany': 'Aucune entreprise associée',
        'tenders.new.toast.created': 'Appel d\'offres créé avec succès !',
        'tenders.new.toast.createError': 'Erreur lors de la création de l\'appel d\'offres',

        // Sectors
        'tenders.new.sector.securityPrivate': 'Sécurité privée',
        'tenders.new.sector.securityElectronic': 'Sécurité électronique',
        'tenders.new.sector.construction': 'BTP / Construction',
        'tenders.new.sector.logistics': 'Logistique',
        'tenders.new.sector.itSoftware': 'Informatique / Logiciels',
        'tenders.new.sector.maintenance': 'Maintenance',
        'tenders.new.sector.consulting': 'Conseil',
        'tenders.new.sector.cleaning': 'Nettoyage',
        'tenders.new.sector.catering': 'Restauration',
        'tenders.new.sector.transport': 'Transport',
        'tenders.new.sector.energy': 'Énergie',
        'tenders.new.sector.healthcare': 'Santé',
        'tenders.new.sector.education': 'Éducation',
        'tenders.new.sector.other': 'Autre',

        // Buyer types
        'tenders.new.buyerType.state': 'État',
        'tenders.new.buyerType.region': 'Région',
        'tenders.new.buyerType.department': 'Département',
        'tenders.new.buyerType.municipality': 'Commune',
        'tenders.new.buyerType.publicEstablishment': 'Établissement public',
        'tenders.new.buyerType.hospital': 'Hôpital / CHU',
        'tenders.new.buyerType.privateCompany': 'Entreprise privée',
        'tenders.new.buyerType.association': 'Association',
        'tenders.new.buyerType.other': 'Autre',

        // Countries
        'tenders.new.country.fr': 'France',
        'tenders.new.country.de': 'Allemagne',
        'tenders.new.country.be': 'Belgique',
        'tenders.new.country.es': 'Espagne',
        'tenders.new.country.it': 'Italie',
        'tenders.new.country.nl': 'Pays-Bas',
        'tenders.new.country.gb': 'Royaume-Uni',
        'tenders.new.country.ch': 'Suisse',
        'tenders.new.country.us': 'États-Unis',
        'tenders.new.country.ma': 'Maroc',
      } : {
